                ...
                Expanded(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, index) => Column(
                      ...
                      children: [
                        Text(projects[index].title.toString()),
                        Text(projects[index].description.toString()),
                        Text(projects[index].uploaderName.toString()),
                        Text(projects[index].uploaderDescription.toString()),
                        Text(projects[index].address.toString()),
                        Text(projects[index].price.toString()),
                        Text(projects[index].votesCount.toString()),
                        Text(projects[index].status.toString()),
                        Image.memory(
                          base64Decode(
