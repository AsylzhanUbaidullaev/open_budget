...
import 'package:open_budget/core/freezed/network_error.dart';
import 'package:open_budget/core/freezed/result.dart';
import 'package:open_budget/core/network/network_options/network_options.dart';
  ...
  static void handleError(DioError error, BuildContext buildContext) {
    ...
    switch (error.response!.statusCode) {
      ...
      case 401:
        ...
        // _userData.deletePincode();
        // _userData.deleteUserId();
        // _userData.deleteUsername();
